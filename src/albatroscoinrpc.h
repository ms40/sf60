...
#ifndef _ALBATROSCOINRPC_H_
#define _ALBATROSCOINRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // Albatroscoin is not connected
...
/**
 * Albatroscoin RPC command dispatcher.
 */
class CRPCTable
{
private:
