...
#ifndef H_ALBATROSCOIN_SCRIPT
#define H_ALBATROSCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CAlbatroscoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Albatroscoin always counted CHECKMULTISIGs
